...
public class Patient {
	...
	public double getBMI() {
		// *** YOUR CODE HERE ***
		return (703 * this.getWeight()) / (this.getHeight() * this.getHeight()); // Dummy return
	}
	...
	public void tagPatient() {
		...
		this.setPatientTag(this.getInitials()
						   + String.valueOf(num1) 
						   + String.valueOf(num2) 
						   + String.valueOf(num3) 
						   + String.valueOf(num4));
	...
	public boolean isUniversalDonor() {
		// YOUR CODE HERE
		if(this.getBloodType().equals(bloodType.O) && this.getRH().equals(rh.NEG)){
			return true;
		}
	...
	public boolean hasCompatibleRHFactor(Patient p) {
		// YOUR CODE HERE
		if(p.getRH().equals(rh.NEG) || this.getRH().equals(rh.POS)) {
			return true;
		}
		return false;
	}
